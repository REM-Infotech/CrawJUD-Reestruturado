...
class BuscadorProcesso(AbstractClassBot):  # noqa: D101
    def buscar_processo(
        self,
        data: BotData,
        ...
        **kwargs: Generic[T],
        ...
        with Client(
            ...
            if data_request.get("id"):
                ...
                resultado = self.desafio_captcha(
                    data=data,
    ...
    def desafio_captcha(
        ...
        **kwargs: Generic[T],
        ...
        while tries < 15:
            ...
            _link2 = f"/processos/{id_processo}?tokenDesafio={token_desafio}&resposta={text}"
